...
**** Trois tables : 
   - Table Match_Submit
     ...
     + Notes :
       * Il y aura moyen de split les matricule grâce aux ";" (split() en python et preg_split en php)
...
**** Utilisations typiques de la base de données avec ma proposition :
	...
	* For each joueur in preg_split(";",/Joueurs/), get /elo/ from table *JOUEURS_ELO* and calculate /new_elo/
